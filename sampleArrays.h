// Sample arrays to use for testing.
// Follows a similar structure to that used for the test arrays in Assignment 1.

#define NUMBER_OF_TESTS 5
const int TEST_ARRAY_KEY = 6666;


const int test_arrays[5][5] = {
